    ...
    internal class NhaSachContext : DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            modelBuilder.Entity<TaiKhoan>().HasData(
                ...
                new TaiKhoan { TenTK = "user1", MatKhau = "pass1", HoTen = "Nguyễn Văn A", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user2", MatKhau = "pass2", HoTen = "Lê Thị B", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user3", MatKhau = "pass3", HoTen = "Trần Văn C", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user4", MatKhau = "pass4", HoTen = "Phạm Thị D", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user5", MatKhau = "pass5", HoTen = "Hoàng Văn E", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user6", MatKhau = "pass6", HoTen = "Đỗ Thị F", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user7", MatKhau = "pass7", HoTen = "Vũ Văn G", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user8", MatKhau = "pass8", HoTen = "Bùi Thị H", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user9", MatKhau = "pass9", HoTen = "Ngô Văn I", VaiTro = "staff" },
                new TaiKhoan { TenTK = "user10", MatKhau = "pass10", HoTen = "Dương Thị K", VaiTro = "staff" }
            );
